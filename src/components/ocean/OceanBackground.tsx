  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(120% 80% at 50% 0%, #062F3C 0%, #041C24 35%, #020B12 70%, #000507 100%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "conic-gradient(from 200deg at 50% -10%, transparent 0deg, rgba(0,217,255,0.18) 18deg, transparent 36deg, rgba(94,242,255,0.12) 60deg, transparent 90deg, rgba(127,255,212,0.1) 130deg, transparent 170deg)",
          filter: "blur(40px)",
        }}
      />
      ...
      {/* caustic glows */}
      <div
        className="absolute -top-40 left-1/3 h-[40rem] w-[40rem] rounded-full animate-pulse-glow"
        style={{ background: "radial-gradient(circle, #00D9FF 0%, transparent 60%)", opacity: 0.18 }}
      />
      <div
        className="absolute top-1/2 -right-40 h-[36rem] w-[36rem] rounded-full animate-pulse-glow"
        style={{ background: "radial-gradient(circle, #7FFFD4 0%, transparent 60%)", opacity: 0.12, animationDelay: "2s" }}
      />
      <div
        className="absolute bottom-0 left-0 h-[40rem] w-[40rem] rounded-full animate-pulse-glow"
        style={{ background: "radial-gradient(circle, #0A4A5A 0%, transparent 60%)", opacity: 0.35, animationDelay: "4s" }}
      />
      ...
      {bubbles.map((b) => (
        <span
          ...
          style={{
            ...
            width: b.size,
            height: b.size,
            background: "radial-gradient(circle at 30% 30%, rgba(255,255,255,0.8), rgba(94,242,255,0.4) 40%, rgba(0,217,255,0.05) 80%)",
            boxShadow: "0 0 8px rgba(94,242,255,0.4)",
  ...
  return (
    ...
    >
      <div className="animate-jelly" style={{ animationDelay: `${delay}s` }}>
        <svg width="120" height="180" viewBox="0 0 120 180" fill="none" className="opacity-50">
          <defs>
          ...
          <g stroke="#5EF2FF" strokeOpacity="0.45" strokeWidth="1" fill="none">
  ...
  return (
    ...
    >
      <svg
        ...
        viewBox="0 0 80 36"
        fill="none"
        style={{ transform: `scale(${scale})`, opacity: 0.55 }}
      >
        <defs>
